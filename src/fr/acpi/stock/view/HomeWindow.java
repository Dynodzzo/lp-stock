...
public class HomeWindow extends JFrame implements ActionListener {
	...
	public HomeWindow(CatalogController catalogCtrl) {
...
*/		
		String[] s = _catalogCtrl.getNamesAllCatalogs();
		System.out.println(s[0]);
		
		modifierListesCatalogues(_catalogCtrl.getNamesAllCatalogs());
		modifierDetailCatalogues(_catalogCtrl.getNamesAllCatalogs());
		modifierNbCatalogues(_catalogCtrl.numberCatalogs());
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btAjouter) {
			...
			if (!texteAjout.equals("")) {
				...
				this._catalogCtrl.createCatalog(new Catalog(texteAjout));
			}
		}
		if (e.getSource() == btSupprimer) {
			...
			if (texteSupprime != null) {
				...
				this._catalogCtrl.deleteCatalog(texteSupprime);
			}
		}
